# ==============================================================================
# 交易程式 1.8.5.3 - 當沖量化終端 (PyQt5 旗艦專業版)
# ==============================================================================
import json
import os
import math
...
def process_group_data(stock_data_collection, wait_minutes, hold_minutes,
    ...
    for i, row in merged_df.iterrows():
        ...
        for item in trigger_list:
            ...
            if cond == 'limit_up':
                # 🟢 修正 1：移除 tracking_stocks.clear()！保留聯合再生帶起來的小弟
...
class CorrelationConfigDialog(BaseDialog):
    def __init__(self, parent=None):
        ...
        self.mode_combo.addItems(["[B] 實戰微觀模擬 (動態攔截結算窗)", "[A] 一整天宏觀連動 (09:00~13:30)"])
    ...
    def get_settings(self):
        mode = "micro" if self.mode_combo.currentIndex() == 0 else "macro"
...
class QuantMainWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("交易程式 1.8.5.3 - 當沖量化終端")
